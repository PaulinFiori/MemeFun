        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form method="POST" action="{{ route('cadastro') }}" class="login100-form validate-form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Digite uma senha">
                            ...
                            <input class="input100" type="password" name="Senha" value="{{ old('Senha') }}">
