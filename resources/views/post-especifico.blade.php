                ...
                <div class="cardbox-heading">
                    ...
                    <div class="media m-0">
                        <div class="d-flex mr-3 cursor-pointer">
                            <img class="img-fluid rounded-circle" src="{{ config('app.url') . '/' . $post->usuario->foto }}" alt="User" onclick="window.location.href = '{{ config('app.url') . '/perfil/' . $post->usuario->id }}'">
                        </div>
                    ...
                    @if($post->anexo != null)
                        @if($post->extensao == 'jpeg' || $post->extensao == 'Webp' || $post->extensao == 'png' || $post->extensao == 'jpg')
                            <div class="cardbox-item">
                                <img class="img-fluid" src="{{ config('app.url') . '/' . $post->anexo }}" alt="Image">
                            </div>
                        @else
                            <div class="cardbox-item">
